 ...
 *
 * @author Troy Bowman
 * @version $Id: Base64Encoder.java,v 1.1 2007/07/21 20:15:04 troy Exp $
 */
...
public class Base64Encoder extends CharacterEncoder {
  ...
  /**
   * We don't care about newlines.  In fact, they cause problems.  This overrides character
   * encoder's encodeLineSuffix and thus stops the newline from getting added.
   *
   * @param aStream
   * @throws IOException
   */
