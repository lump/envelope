...
public enum Revision {
  ...
  Header,
  /** Same as $Header: /export/cvsroot/envelope/src/net/lump/lib/util/Revision.java,v 1.10 2009/03/18 00:38:52 troy Alpha $, except that the rcs filename is without a path. */
  Id,
  ...
  private final String[] REVS = new String[]{
      ...
      "$Header: /export/cvsroot/envelope/src/net/lump/lib/util/Revision.java,v 1.10 2009/03/18 00:38:52 troy Alpha $",
