...
public enum Revision {
  ...
  RCSHeader,
  /** Same as $Header: /export/cvsroot/envelope/src/net/lump/lib/util/Revision.java,v 1.7 2009/03/17 23:53:26 troy Exp $, except that the rcs filename is without a path. */
  Id,
...
//  Log,
  ...
  private final String[] REVS = new String[]{
      ...
      "$Header: /export/cvsroot/envelope/src/net/lump/lib/util/Revision.java,v 1.7 2009/03/17 23:53:26 troy Exp $",
      "$RCSHeader$",
