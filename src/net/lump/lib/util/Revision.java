...
public enum Revision {
  ...
  RCSHeader,
  /** Same as $Header: /usr/cvsroot/envelope/src/net/lump/lib/util/Revision.java,v 1.9 2009/03/17 23:58:21 troy Exp $, except that the rcs filename is without a path. */
  Id,
...
//  Log,
  ...
  private final String[] REVS = new String[]{
      ...
      "$Header: /usr/cvsroot/envelope/src/net/lump/lib/util/Revision.java,v 1.9 2009/03/17 23:58:21 troy Exp $",
      "$RCSHeader$",
