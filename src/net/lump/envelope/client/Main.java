...
//    }
    ...
    try {
      // FlatLaf replaces the old Incors Alloy look-and-feel, whose licence key
      // ("borrow the jetbrains license for now") expired a long time ago.
      ...
      try {
        // try nimbus next, since it's the coolest one in the JDK itself
