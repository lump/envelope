 ...
 *
 * @author Troy Bowman
 * @version $Id: Control.java,v 1.5 2007/08/18 23:20:11 troy Exp $
 */
  ...
  private Object dispatch(Command command) throws RemoteException {
    ...
    try {
      ...
      dao = (DAO)Class.forName(
          DAO_PATH
          + command.getCmd().getFacet().name()).newInstance();
      ...
      if (e instanceof ClassNotFoundException)
        throw new IllegalArgumentException("Bad Facet " + command.getCmd()
            .getFacet()
            .name(), e);
      if (e instanceof IllegalAccessException
          || e instanceof NoSuchMethodException)
        throw new IllegalArgumentException("Bad Command " + command.getCmd()
            .name(), e);
      if (e instanceof InstantiationException)
        throw new IllegalArgumentException("Could not instantiate "
                                           + command.getCmd().getFacet().name(),
                                           e);
