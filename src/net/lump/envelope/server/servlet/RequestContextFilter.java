 ...
 * {@code [GET /envelope/info/ready 127.0.0.1] began transaction} and one begun
 * for a client as {@code [POST /envelope/invoke 10.0.0.5] [guest listTransactions]
 * began transaction}, the second bracket being what {@link
 * net.lump.envelope.server.Controller} adds once it has authenticated the
 * command.  The remote address is the real client's when Tomcat's RemoteIpValve
